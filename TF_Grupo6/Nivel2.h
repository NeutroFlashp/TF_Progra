...
namespace TFGrupo6 {
	...
	public:
		Nivel2(void)
		{
			InitializeComponent();
			srand(time(NULL));
			c = pnlCanvas2->CreateGraphics();
			space = BufferedGraphicsManager::Current;
			buffer = space->Allocate(c, pnlCanvas2->ClientRectangle);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pnlCanvas2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->pnlCanvas2->Name = L"pnlCanvas2";
			this->pnlCanvas2->Size = System::Drawing::Size(853, 468);
			this->pnlCanvas2->TabIndex = 0;
			this->pnlCanvas2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Nivel2::pnlCanvas2_Paint);
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(185, 72);
...
#pragma endregion
	...
	private: System::Void pnlCanvas2_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
	}
};
}
