...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pnlCanvas->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->pnlCanvas->Name = L"pnlCanvas";
			this->pnlCanvas->Size = System::Drawing::Size(853, 468);
			this->pnlCanvas->TabIndex = 0;
			this->pnlCanvas->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &FrmMain::pnlCanvas_Paint);
			// 
			// lblTexto
			// 
			...
			this->lblTexto->Location = System::Drawing::Point(704, 17);
			this->lblTexto->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lblTexto->Name = L"lblTexto";
			this->lblTexto->Size = System::Drawing::Size(71, 13);
			...
			this->lblContador->Location = System::Drawing::Point(774, 14);
			this->lblContador->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lblContador->Name = L"lblContador";
			this->lblContador->Size = System::Drawing::Size(69, 15);
			...
			this->ClientSize = System::Drawing::Size(854, 468);
